...
from openapi_server.models.test_auth_get200_response import TestAuthGet200Response
...
@router.get(
    "/test-auth",
    responses={
        200: {"model": TestAuthGet200Response, "description": ""},
    },
    tags=["default"],
    summary="テスト認証API",
    response_model_by_alias=True,
...
) -> TestAuthGet200Response:
    """"""
    if not BaseDefaultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDefaultApi.subclasses[0]().test_auth_get()
